...
function Home() {
  return (
    <div className='home'>
      <div className="bgimg-1" style={{ backgroundImage: `url("${process.env.PUBLIC_URL}/images/overlooking-anaconda-mt-3.jpg")` }}>
        <div className="caption">
          <span className="border">Anaconda, MT </span>
        </div>
      </div>
      ...
      <div className="bgimg-2" style={{ backgroundImage: `url("${process.env.PUBLIC_URL}/images/coshocton_1846.jpg")` }}>
        <div className="caption">
      ...
      <div className="bgimg-3" style={{ backgroundImage: `url("${process.env.PUBLIC_URL}/images/crest.jpg")` }}>
        <div className="caption">
          <span className="border" style={{
            backgroundColor: "#FFF",
            fontSize: '25px',
